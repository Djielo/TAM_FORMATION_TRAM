    ...
    questions: [
      {
        ...
        cardPrompt:
          "Quelles sont les étapes de la sortie du dépôt et de la mise en ligne ?",
        answer:
          "1. Préparation de la rame sur le remisage selon la partie 1 du RCT.\n2. Rame prête : demander l'autorisation de sortie au PCC, qui construit l'itinéraire de sortie.\n3. Sortie impossible pour raison technique : informer le PCC et suivre ses consignes. Seul le PCC peut autoriser un changement de matériel.\n4. Avant sortie dépôt : test télécommande d'aiguille (arrêt au panneau voie E au CEMH, ou en marche à l'interface JP). Tester G, TD, D et positionnement INDIR.\n5. Test balises PETRARQUE : balise arrière OK → feu avant barrière allumé. Balise avant OK → ouverture barrière. Défaut → appel PCC.",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        cardPrompt:
          "Quel doit être le comportement du conducteur dans la rame ?",
        answer:
          "1. Présence en cabine réservée aux cadres, maîtrise et maintenance TaM en mission, formateurs, ou personnes munies d'une autorisation écrite. Signalement obligatoire au PCC.\n2. Porte de cabine fermée en circulation. Effets personnels rangés dans le placard.\n3. Conduite assise. Position de vigilance (buste droit, pieds au sol) pour actionner toute commande d'urgence, y compris le FS.\n4. Interdit de fumer, de s'alimenter, d'utiliser un téléphone avec ou sans oreillettes. Phonie en mains libres hors arrêt.\n5. Arrêt en ligne : rester au poste de conduite, feux de détresse.\n6. Hors action courante, ne pas quitter le tramway en ligne sauf force majeure après évacuation : informer le PCC et appliquer les mesures anti-accident (BS p. 35).\n7. Quitter la cabine : manipulateur neutre, clé KC emportée, porte fermée (BS p. 35).\n8. Anomalie de service : annonce clientèle via sonorisation intérieure.\n9. Rame arrêtée : ouverture de la porte cabine autorisée pour s'adresser à la clientèle.",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        cardPrompt:
          "Quelles sont les consignes de rebroussement sur voie unique ?",
        answer:
          "1. Rebroussement après station : s'engager jusqu'au repère de rebroussement (ex. Boirargues L3).\n2. Après autorisation PCC : changer de cabine, contrôler l'aiguille, se diriger vers le quai sur la voie opposée.\n@@INFO@@\nEn cas de conflit (deux rames opposées en VU) ou SM rouge (problème d'aiguillage) :\nLa rame la plus proche de l'évitement rebrousse après autorisation PCC. Voyageurs à bord conseillés, après accord PCC.\nDégager au préalable l'appareil de voie de la station quittée si besoin.\nRebroussement à 5 km/h max, dépasser l'évitement, dégager l'aiguille de sortie.\nInformer le PCC de la position au retour sur le quai.\nRepartir vers la station d'évitement après autorisation PCC, arrêt au SM de sortie, s'engager au vert.",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        cardPrompt:
          "Quelles sont les consignes en cas de poignée d'alarme ou défaut porte ?",
        answer:
          "1. Poignée tirée pendant le dégagement du quai (BPIL phonie + SIE) : FU ou FMS, portes libérées après 15 s, risque d'ouverture côté entrevoie.\n2. Éviter toute ouverture du mauvais côté : réarmer la poignée ou sélectionner le bon côté de déverrouillage (401 = côté pré-sélectionné).\n3. Dialoguer avec l'auteur via interphonie, informer les voyageurs une fois la cause identifiée.\n4. Vérifier la sécurité des voyageurs avant redémarrage (chutes possibles après FU ou FMS).\n5. Même consigne rame à l'arrêt en ligne, hors zone de dégagement de quai.\n6. Mode dégradé défaut porte : condamner la porte, apposer l'autocollant d'information clientèle, contrôler sur la console SIE.\n7. Signaler sur la feuille de route et au PCC.\n@@WARNING@@\nHors zone de dégagement : libération des portes 15 s après tirage de poignée, côté entrevoie si mauvais côté, sans action conducteur.\nImpossible de condamner : le PCC peut ordonner d'isoler le contrôle portes (déplombage commutateur armoire de loge), après évacuation impérative de la rame.",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        cardPrompt:
          "Quelles sont les consignes de communication avec la clientèle ?",
        answer:
          "1. Garant de l'image TaM : attitude tournée vers le confort et la sécurité des clients.\n2. Situation perturbée ou incident : information impérative, ton rassurant pour éviter la panique.\n3. Situation imprévue ou arrêt prolongé : informer via la sonorisation des salles, expliquer l'évolution et rassurer.\n4. Phonie : respirer après connexion (premier mot souvent perdu). Parler calmement, mots détachés, voix posée. Bouche à 5-6 cm du micro.\n@@INFO@@\nExemples d'annonces type :\nArrêt prolongé : retard et évolution de la situation.\nDescente voyageurs : quitter la rame, préciser le relais (bus, rame suivante ou devant).\nTerminus intermédiaire (Occitanie, L. Blum) : reporter sur la rame suivante.\nFumeurs : éteindre les cigarettes.\nPortes : se tenir en arrière des portes.",
      },
    ],
  },
